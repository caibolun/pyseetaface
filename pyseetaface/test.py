...
@LastEditTime: 2020-05-07 18:00:48
'''
import seetaface
import cv2
...
for rect, score, points81, points5 in zip(rects, scores, mark81, mark5):
    ret, q = model.evaluate(img, rect, points5)
    ...
    img = cv2.putText(img, "%.2f"%q, (rect[0], rect[1]+rect[3]+15), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0,255,0), 1)
    for p in points81:
